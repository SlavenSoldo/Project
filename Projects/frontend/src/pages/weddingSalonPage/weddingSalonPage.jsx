    ...
    <>
      ...
      {!addSalon ? (
        <div className='container weddingSalonContainer'>
          <div className='row'>
            {(!props.autentification.isGuest && !gostDatum &&
              ...
              <div className='col-lg-12 col-md-12 col-sm-12 mb-12'>
                <div className='card justify-content-center align-items-center'>
                  <img
                    src='https://static.slobodnadalmacija.hr/Archive/Images/2018/07/02/Mozaik/10036845.jpg'
                    className='card-img-top salonImage'
                    alt='Salon'
                  />
                  <div className='card-body cardBodyWeddingSalon'>
                    ...
                    <p className='card-text rezervationDate'>Datum svadbe: {gostDatum}</p>
                    <div className='rezervationDate'>
